...
import {SubLeadWrapper, NewsTitle, SubTitle, A, ATag} from '../../Styled/Home.Styled'
  ...
  return (
    <>
      <SubLeadWrapper>
        ...
        <A href="/single">
          <ATag>
          <img src="https://www.prothomalo.com/widgets/muktijuddho-50/images/banner.png?v=1" alt="ads" />
          </ATag>
        </A>
      </SubLeadWrapper>
    </>
